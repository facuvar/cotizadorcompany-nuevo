...
try {
    ...
    if ($result->num_rows === 0) {
        throw new Exception("No se encontró la categoría GIRACOCHES en la base de datos.");
    }
    ...
    if ($resultOpciones->num_rows === 0) {
        throw new Exception("No se encontraron modelos para la categoría GIRACOCHES.");
    }
...
<div class="container-fluid px-4">
    <h1 class="mt-4">Validación de Datos - GIRACOCHES</h1>
    ...
    <div class="card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            <div>
                ...
                Modelos importados de GIRACOCHES
            </div>
            <div>
                <a href="index.php" class="btn btn-outline-primary btn-sm me-2">
                    <i class="fas fa-arrow-left"></i> Volver al Panel
                </a>
                <a href="import_giracoches.php" class="btn btn-warning btn-sm">
        ...
        <div class="card-body">
            ...
            <div class="alert alert-warning">
                No se encontraron modelos de GIRACOCHES en la base de datos.
            </div>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <p>
                Los modelos de GIRACOCHES mostrados arriba están disponibles para su cotización.
                Puede acceder a ellos desde el cotizador seleccionando la categoría GIRACOCHES.
            </p>
...
<div class="modal fade" id="editModelModal" tabindex="-1" aria-labelledby="editModelModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="editModelForm" action="update_giracoches_model.php" method="post">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    editButtons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            fetch('get_giracoches_model.php?id=' + modelId)
